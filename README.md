# CHEMVERSE 4.0 — Authentic Apparatus Lab

ห้องปฏิบัติการเคมีเสมือน 3D ภาษาไทยสำหรับนักเรียนมัธยมศึกษา Version 4 เพิ่ม **Apparatus State Machine** และ **Real-time Simulation Clock** ให้การจับอุปกรณ์ ค่าที่วัด กราฟ หลักฐานระดับมหภาค Particle View และสมการเคมีใช้สถานะเดียวกัน
...
- ขั้นไทเทรตใช้ปิเปต บิวเรต stopcock ขวดรูปชมพู่ และ pH probe ตามหน้าที่จริง
- ล็อก stopcock จนกว่าจะเตรียมอุปกรณ์ครบ ลดการกดข้ามขั้นตอน
- ปรับอัตราไหล 0.05–2.00 mL/s และหยุดใกล้จุดสมมูลได้เอง
...
- กราฟและ Particle View อยู่หน้าเดียวกับฉาก 3D และอัปเดตประมาณ 10 ครั้งต่อวินาที
