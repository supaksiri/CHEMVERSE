# คู่มือนำ CHEMVERSE 3.0 ขึ้น GitHub Pages
...
4. แตกไฟล์ ZIP และอัปโหลดไฟล์ภายในโฟลเดอร์ `chemverse-v3` ทั้งหมด โดยต้องเห็น `package.json` อยู่ระดับบนสุด
...
git init
git add .
git commit -m "Launch CHEMVERSE 3.0 Scientific Fidelity Lab"
git branch -M main
